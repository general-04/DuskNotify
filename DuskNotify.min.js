...
getAnimationDuration(effect) {
  ...
  return effectDurations[effect] || effectDurations.default;
    ...
    static success(options) {
      return new Dusk({ icon: 'success', ...options });
    }

    static info(options) {
      return new Dusk({ icon: 'info', ...options });
    }

    static warning(options) {
      return new Dusk({ icon: 'warning', ...options });
    }

    static error(options) {
      return new Dusk({ icon: 'error', ...options });
    }
    
    static ban(options) {
      return new Dusk({ icon: 'ban', ...options });
    }

    static loading(options) {
      return new Dusk({ icon: 'loading', ...options });
    }
    
    static ask(options) {
      return new Dusk({ icon: 'ask', ...options });
    }

    static shield(options) {
      return new Dusk({ icon: 'shield', ...options });
    }

    static clock(options) {
      return new Dusk({ icon: 'clock', ...options });
    }

    static bell(options) {
      return new Dusk({ icon: 'bell', ...options });
    }

    static search(options) {
      return new Dusk({ icon: 'search', ...options });
    }

    static setting(options) {
      return new Dusk({ icon: 'setting', ...options });
    }

    // Toast variants
    static successToast(options) {
      return Dusk.showToast({ icon: 'success', ...options });
    }

    static infoToast(options) {
      return Dusk.showToast({ icon: 'info', ...options });
    }

    static warningToast(options) {
      return Dusk.showToast({ icon: 'warning', ...options });
    }

    static errorToast(options) {
      return Dusk.showToast({ icon: 'error', ...options });
    }
    
    static banToast(options) {
      return Dusk.showToast({ icon: 'ban', ...options });
    }

    static loadingToast(options) {
      return Dusk.showToast({ icon: 'loading', ...options });
    }
    static askToast(options) {
      return Dusk.showToast({ icon: 'ask', ...options });
    }

    static shieldToast(options) {
      return Dusk.showToast({ icon: 'shield', ...options });
    }

    static clockToast(options) {
      return Dusk.showToast({ icon: 'clock', ...options });
    }

    static bellToast(options) {
      return Dusk.showToast({ icon: 'bell', ...options });
    }

    static searchToast(options) {
      return Dusk.showToast({ icon: 'search', ...options });
    }

    static settingToast(options) {
      return Dusk.showToast({ icon: 'setting', ...options });
    }
  }
